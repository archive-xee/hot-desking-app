...
export default function MovePage() {
  ...
  return (
    <>
      ...
      <p>
        4-2-1. 유저가 사용하고 있는 자리가 있는지 물어봄 User.usingTicketId (좌석일때만! 스터디룸, 대여함, 사물함은
        해당없음)
      </p>
      ...
      <div className="border">query GetSeatTicketId($usingTicketId: String!) [ Seat(id :$usingTicketId) ]</div>
      <div className="border">
        mutation MoveUserSeat($usingTicketId: String!, $oldSeatType: String!, $oldSeatNumber: String!, $newSeatType:
        String!, $newSeatNumber: String!) [ Seat(oldSeatType: $oldSeatType, oldSeatNumber: $oldSeatNumber ) [ null ]
        Seat(newTicketId: $usingTicketId, newSeatType: $newSeatType, newSeatNumber: $newSeatNumber ) [ newTicketId ] ]
      </div>
    </>
  )
}
