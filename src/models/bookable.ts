...
// MockClass
export const history1 = new History(
  "1",
  "seat",
  "1",
  "1",
...
export const meetingRoom1 = new MeetingRoomModel(
  "1",
  "wontae",
  "1",
  [history1],
...
export const meetingRoom2 = new MeetingRoomModel(
  "2",
  null,
  "2",
  [history1],
...
export const locker1 = new LockerModel(
  "1",
  "wontae",
  "1",
  [history1],
...
export const rentbox1 = new RentBoxModel(
  "1",
  "wontae",
  "1",
  [history1],
...
export const rentbox2 = new RentBoxModel(
  "2",
  null,
  "2",
  [history1],
